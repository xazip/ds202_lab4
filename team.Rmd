...
New Question: Is there anything we can conclude from the Height and Weight of a player to the positiions of a player on Iowa State Football Team? 
```{r}
...
print(Complete_Join_Biography)

Complete_Join_Biography %>% ggplot(aes(x = Position, y = Height_in_Centimeters, fill = Position))+
...
Complete_Join_Biography %>% ggplot(aes(x = Position, y = Weight, fill = Position))+
  geom_boxplot(na.rm = TRUE)+
